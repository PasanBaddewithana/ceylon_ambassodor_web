...
const Navbar = () => {
  return (
    <nav className="bg-transparent flex items-center border-b-2 border-[#031c3f] text-[#031c3f]  fixed top-6 w-full z-10 font-kollektif font-bold text-sm">
      <div className="container  mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center w-[20%]">
          <div className="flex items-center bg-transparent  justify-between ">
            ...
            <div className="flex items-center ml-4 mr-20">
              <TrackOrder />

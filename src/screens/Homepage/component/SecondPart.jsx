    ...
    <div className="bg-[#181728] w-full h-[550px] flex justify-center items-center relative">
      ...
      <div className="w-1/2 h-full flex flex-col justify-center items-center">
        <div className="flex flex-col justify-center items-start">
          ...
          <p className="text-white text-4xl font-MontserratMedium font-semibold" data-aos="fade-up" data-aos-duration="1000">
            "Crafting Brands{" "}
          </p>
          <p className="text-white text-4xl font-MontserratMedium font-semibold mb-5" data-aos="fade-up" data-aos-duration="1500">
            That Inspire"
          </p>
          <div className="h-[2px] w-[500px] bg-[#BC9C61] "></div>
          <p className="text-white text-[14px]  font-Montserrat mt-4 w-[390px]" data-aos="fade-up" data-aos-duration="2000">

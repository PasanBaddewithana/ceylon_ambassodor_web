    ...
    <div className="flex flex-row justify-center items-center">
      <div className="flex flex-row justify-center items-center w-1/2 p-20">
        ...
        <div className="flex flex-col justify-center items-start ml-10 pl-10">
          <p className="text-[20px] font-Montserrat text-customBlue mb-0">
            Let's{" "}
          </p>
          <p className="text-[28px] font-Montserrat text-customBlue font-semibold mt-[-8px]">
            Fly Higher Together
          </p>
        </div>
      </div>
      <div className="w-1/2 text-[13px] pr-[140px] font-Montserrat justify-center items-start">
